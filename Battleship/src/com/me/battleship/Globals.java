...
public class Globals {
    ...
    static final Vector2 RotateZoneTopLeft = new Vector2(600f, 550f);
    static final Vector2 RotateZoneSize = new Vector2(150f, 100f);

    static final Vector2 GridTopLeft = new Vector2(30f, 30f);
    static final float GridSize = 550f;
    static final int GridDimensions = 9;
    static final float TileSize = GridSize / GridDimensions;
    ...
    static boolean insideObject(float x, float y, BaseObject o) {
        if (x > o.TopLeft.x && x < o.TopLeft.x + o.Size.x && y > o.TopLeft.y
                && y < o.TopLeft.y + o.Size.y)
            return true;
        return false;
    }
